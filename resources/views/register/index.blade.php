    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="/register" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="username" name="username" type="text" autocomplete="username" required value="{{ old('username') }}"
                            class="block px-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('username')
                            <p class="text-red-500 text-xs">Username tidak boleh sama.</p>
                        @enderror
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" name="email" type="email" autocomplete="email" required
                            class="block px-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('email')
                            <p class="text-red-500 text-xs">Email tidak boleh sama.</p>
                        @enderror
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        @error('password')
                            <p class="text-red-500 text-xs">Password minimum 8 karakter.</p>
                        @enderror
                    </div>
                    <div class="mt-2">
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                Already member?
                <a href="/login"
                    class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 hover:underline">Login</a>
            </p>
        </div>
    </div>
@endsection
